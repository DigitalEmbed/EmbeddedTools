...
int main(){
  ...
  */
  printf("Bigger variable: %d\n", (int) SoftMath.bigger(i16NumberA, i16NumberB));

  /*!
    Printing the smaller variable...
  */
  printf("Smaller variable: %d\n", (int) SoftMath.smaller(i16NumberA, i16NumberB));
